...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.servant_yuhun.setFont(font)
        ...
        self.servant_yuhun_01 = QtWidgets.QComboBox(self.widget_27)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.servant_yuhun_01.sizePolicy().hasHeightForWidth())
        self.servant_yuhun_01.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        self.servant_yuhun_01.setFont(font)
        self.servant_yuhun_01.setObjectName("servant_yuhun_01")
        self.horizontalLayout_22.addWidget(self.servant_yuhun_01)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_10.setText(_translate("Dialog", "第一御魂"))
        self.label_11.setText(_translate("Dialog", "第二御魂"))
